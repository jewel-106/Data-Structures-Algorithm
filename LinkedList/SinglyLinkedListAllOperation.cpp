...
class LinkedList{
    ...
    public:
        ...
        void insertAtEnd(int value){
            ...
            // If the list is empty, updat the head to the new node
            if(!head){
                head = newNode;
                return;
            }
        ...
        //Fucntion to print the nodes of the linked list
        void display(){
            if(!head){
                cout<<"List is empty."<<endl;
                return;
...
int main()
{
    ...
    cout<<"Linked List alter insertions: ";
    list1.display();
    ...
    // Delete element form a specific position
